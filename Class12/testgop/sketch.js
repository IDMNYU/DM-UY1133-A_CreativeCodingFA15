...
function setup() {
  ...
  for(var i = 0;i<NUMDONALDS;i++)
  {
    ...
    donalds[i] = new theTrump(whichdonald, random(20,50)); // make me a bunch of theCircle class
  }
...
function draw() {
  ...
  for(var i = 0;i<NUMDONALDS;i++)
  {
   donalds[i].doit(mouseX, mouseY);
  }

  resetMatrix(); // clear all translate/rotate stuff
