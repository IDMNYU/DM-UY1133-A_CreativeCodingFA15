...
var osc = new Array(numShoeStrings);
...
function draw() {
  ...
  for(var i  = 0;i< numShoeStrings;i=i+1)
  {
    ...
    var drunkx = myDrunkenCurve(-100, 100, 30);
    var drunky = myDrunkenCurve(-100, 100, 30);;
    ...
    var f = map(x2[i], 0, width-1, 50, 700);
    osc[i].freq(f);
    var a = 1.0-(y2[i]/(height-1));
    osc[i].amp(a*.01, 0.05); // turn up sine wave
